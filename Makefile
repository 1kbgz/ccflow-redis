...
lint-py:  ## lint python with ruff
	python -m ruff check ccflow_redis
	python -m ruff format --check ccflow_redis
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix ccflow_redis
	python -m ruff format ccflow_redis
...
test:  ## run python tests
	python -m pytest -v ccflow_redis/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v ccflow_redis/tests --cov=ccflow_redis --cov-report term-missing --cov-report xml
